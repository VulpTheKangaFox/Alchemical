...
public class AirElementalModel<T extends Entity> extends EntityModel<T> {

    public static final ModelLayerLocation LAYER = new ModelLayerLocation(new ResourceLocation(Alchemical.MOD_ID, "air_elemental"), "main");
    private final ModelPart main;

    public AirElementalModel(ModelPart root) {
