...
public class WaterElementalModel<T extends Entity> extends EntityModel<T> {

    public static final ModelLayerLocation LAYER = new ModelLayerLocation(new ResourceLocation(Alchemical.MOD_ID, "water_elemental"), "main");
    private final ModelPart main;

    public WaterElementalModel(ModelPart root) {
