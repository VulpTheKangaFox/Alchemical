...
public class FireElementalModel<T extends Entity> extends EntityModel<T> {

    public static final ModelLayerLocation LAYER = new ModelLayerLocation(new ResourceLocation(Alchemical.MOD_ID, "fire_elemental"), "main");
