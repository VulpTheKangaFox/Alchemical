...
public class AirElemental extends AbstractElemental implements NeutralMob {

    public AirElemental(EntityType<? extends PathfinderMob> entityType, Level level) {
    ...
    public boolean doHurtTarget(Entity pEntity) {
        ...
        if (flag) {
            ...
            if (pEntity instanceof LivingEntity) {
                ...
                if (i > 0) {
                    ((LivingEntity) pEntity).addEffect(new MobEffectInstance(MobEffects.BLINDNESS, i * 20, 0), this);
                }
            }
            this.stopBeingAngry();
