...
// TODO: This is a walking elemental.
public class EarthElemental extends AbstractElemental implements NeutralMob {

    public EarthElemental(EntityType<? extends PathfinderMob> entityType, Level level) {
    ...
    public boolean doHurtTarget(Entity pEntity) {
        ...
        if (flag) {
            ...
            this.stopBeingAngry();
            this.playSound(SoundEvents.DRIPSTONE_BLOCK_BREAK, 1.0F, 1.0F);
        }
        return flag;
    }
