...
public class WaterElemental extends AbstractElemental implements NeutralMob {

    public WaterElemental(EntityType<? extends PathfinderMob> entityType, Level level) {
    ...
    public boolean doHurtTarget(Entity pEntity) {
        ...
        if (flag) {
            ...
            if (pEntity instanceof LivingEntity) {
                ...
                if (i > 0) {
                    ((LivingEntity) pEntity).addEffect(new MobEffectInstance(MobEffects.CONFUSION, i * 20, 0), this);
                }
            }
            this.stopBeingAngry();
            this.playSound(SoundEvents.BOAT_PADDLE_WATER, 1.0F, 1.0F);
        }
        return flag;
    }
